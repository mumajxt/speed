    ...
    <div v-if="record" class="drawer animate__animated" :class="visible?'animate__fadeInUp':'animate__fadeOutDown'" @click.stop>
      ...
      <div class="drawer-body">
        <div class="attribute-list">
          ...
          <div class="attribute-list-item">
            <label>管理</label>
            <p v-text="record.admin.nickname"></p>
          </div>
          <div class="attribute-list-item comment">
            <label>备注</label>
            <p v-if="record.comment" v-text="record.comment" :title="record.comment"></p>
            <p v-else class="grey">暂无备注</p>
          </div>
      ...
      <div class="drawer-footer">
        ...
        <span class="divider"></span> -->
        <div class="drawer-footer-btn drawer-footer-btn-red" @click="$emit('readyToDeleteRecord',record);close()">删除</div>
        <span class="divider"></span>
        <div class="drawer-footer-btn drawer-footer-btn-yellow" @click="$emit('updateRecord',record);close()">修改</div>
      </div>
    </div>
  </div>
</template>
